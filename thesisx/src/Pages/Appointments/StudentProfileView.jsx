...
const StudentProfileView = () => {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                ...
                const response = await fetch(`${apiDomain}/api/user/getstudentbyid/${id}`, {
                    method: "GET",
                    headers: {
    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            <h1 className="text-[hsl(240,10%,20%)] dark:text-[hsl(240,10%,80%)] font-bold text-3xl mb-4">Student Profile</h1>
