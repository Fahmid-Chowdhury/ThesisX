...
const PublicationForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let url = apiDomain + "/api/faculty/publications/add";

            if (user && user.role === 'STUDENT') {
                url = apiDomain + "/api/student/contributions/add";
            }
    ...
    return (
        <div className="bg-[hsl(0,0,100)] dark:bg-black p-6 rounded-lg shadow-lg max-w-2xl mx-auto border border-[hsl(0,0,80)] dark:border-[hsl(0,0,20)]">
            <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">
                Add a New {user && user.role === 'FACULTY' ? 'Publication' : 'Contribution'}
            </h1>
            {message && (
                <p
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                    {loading ? 'Adding...' : (user && user.role === 'FACULTY' ? 'Add Publication' : 'Add Contribution')}
