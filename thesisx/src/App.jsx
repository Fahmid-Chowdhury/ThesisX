    ...
    return (
        <>
            <div className="h-screen bg-[hsl(0,0,95%)] dark:bg-[hsl(0,0,5%)] flex items-center justify-center">
                <div className="bg-[hsl(0,0,100%)] dark:bg-[hsl(0,0,0)] p-[50px] shadow-md dark:shadow-md rounded-xl max-w-[900px] m-5 text-black dark:text-white">
                        ...
                        <div>
                            <form action="">
                                <div className='flex flex-col justify-center gap-2'>
                                    ...
                                    <input type="email" className='border outline-1 border-[hsl(0,0,30%)] dark:border-[hsl(0,0,70%)] rounded-lg py-2 px-4 bg-transparent' placeholder='Email'/>
                                </div>
                                <div className='flex flex-col justify-center gap-2 mt-3'>
                                    <label htmlFor="text">Password</label>
                                    <input type="password" className='border outline-1 border-[hsl(0,0,30%)] dark:border-[hsl(0,0,70%)] rounded-lg py-2 px-4 bg-transparent' placeholder='password'/>
                                </div>
