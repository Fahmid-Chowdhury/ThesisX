                        ...
                        <div className='h-full flex flex-col relative'>
                            ...
                            }
                            {
                                ...
                                <div className="absolute z-10 w-full h-full scale-110 backdrop-blur-sm flex flex-col items-center justify-center">
                                    ...
                                    <button className='px-6 py-2 bg-themeColDark dark:bg-themeColLight hover:bg-themeColLight dark:hover:bg-themeColDark hover:bg-opacity-80 text-white rounded-full' disabled={loading} onClick={() => {
                                        navigate('/signin')
                                    }}>
                                        Sign In
                                    </button>
                            ...
                            {step === 1 &&
                                <div className='flex flex-col justify-between h-full transition-all duration-500 transform ease-in-out'>
                                    ...
                                    <div className='mt-10 flex items-center lg:justify-end justify-between gap-5'>
                                        <button className='lg:px-6 lg:py-2 dark:hover:bg-themeColDark hover:bg-themeColLight  hover:bg-opacity-40 dark:hover:bg-opacity-40 text-black dark:text-white rounded-full' disabled={loading} onClick={() => {
                                            navigate('/signin')
                                        }}>
                                            Sign In
                                        </button>
                                        <button form='verify-email' className='px-6 py-2 bg-themeColDark dark:bg-themeColLight hover:bg-themeColLight dark:hover:bg-themeColDark hover:bg-opacity-80 text-white rounded-full' disabled={loading}>
                                            Continue
                                        </button>
                                    </div>
                                </div>
                            ...
                            {step === 2 &&
                                <div>
                                    ...
                                    <div className='mt-10 flex items-center lg:justify-end justify-between gap-5'>
                                        ...
                                        <button className='lg:px-6 lg:py-2 dark:hover:bg-themeColDark hover:bg-themeColLight  hover:bg-opacity-40 dark:hover:bg-opacity-40 text-black dark:text-white rounded-full' onClick={() => {
                                            setStep(1)
                                        }}>
                                            Back
                                        </button>
                                        <button
                                            className="px-6 py-2 bg-themeColDark dark:bg-themeColLight hover:bg-themeColLight dark:hover:bg-themeColDark hover:bg-opacity-80 text-white rounded-full"
