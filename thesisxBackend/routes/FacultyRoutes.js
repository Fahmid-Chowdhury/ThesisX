...
import { GetFacultyInfo, SetSupervisorRequest, addPublication, editPublication, removePublication, getPublications } from "../controllers/FacultyController.js"
...
router.get("/publications", checkAuth, getPublications);
